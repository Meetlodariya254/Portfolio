...
const PROJECTS = [
  ...
  },
  {
    ...
    url: 'github.com/Meetlodariya254/EventFlow',
    accentColor: '#10b981',
    gradientFrom: '#0f1a0f',
    gradientTo: '#1a2e1a',
    preview: 'green',
  ...
  },
  {
    id: 'proj-4',
    num: '04',
    title: 'Interactive Birthday Wish Website',
    desc: 'Dynamic, engaging celebration card web app built with responsive HTML5, vibrant CSS animations, and Vanilla JavaScript.',
    stack: ['HTML5', 'CSS3', 'JavaScript'],
    url: 'github.com/Meetlodariya254/Birthday-Wish',
    accentColor: '#f59e0b',
    gradientFrom: '#0f1a2e',
    gradientTo: '#1a2e3a',
    preview: 'kanban',
